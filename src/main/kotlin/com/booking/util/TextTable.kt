 ...
 *
 * Columns auto-size to their widest cell (header included), with
 * per-column alignment. The renderer is deliberately dependency-free so
 * it can be used across the reporting and analytics menus without
...
class TextTable(
     ...
     * Append a row.
     *
     * Cells beyond the header count are ignored; short rows are padded
     * with empty strings.
     */
