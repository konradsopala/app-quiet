...
class AuditLog {
    ...
    enum class Action {
        ...
        LOYALTY_TIER_CHANGED, REVIEW_ADDED,
        RESOURCE_REGISTERED, RESOURCE_DELETED,
        SNAPSHOT_SAVED, SNAPSHOT_LOADED,
        STAFF_REGISTERED, STAFF_DEACTIVATED, STAFF_REACTIVATED, SHIFT_ADDED, SHIFT_REMOVED, STAFF_ASSIGNED,
        GIFT_CARD_ISSUED, GIFT_CARD_RELOADED, GIFT_CARD_REDEEMED, GIFT_CARD_REVERSED,
        GIFT_CARD_VOIDED, GIFT_CARD_EXPIRED,
        OPERATOR_REGISTERED, OPERATOR_SIGNED_IN, OPERATOR_SIGN_IN_FAILED, OPERATOR_LOCKED,
        OPERATOR_SIGNED_OUT, OPERATOR_PIN_CHANGED, OPERATOR_DEACTIVATED, OPERATOR_OVERRIDE,
        ACCESS_DENIED
    }
